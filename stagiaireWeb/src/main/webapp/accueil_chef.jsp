...
<div class="all">
    ...
    <div class="lead">
    <p>En tant que Chef DRH de cette application, vous détenez un ensemble puissant de responsabilités pour faciliter la gestion efficace des ressources humaines. Vous avez la possibilité de vous authentifier en toute sécurité, assurant ainsi l'accès privilégié à des fonctionnalités essentielles. La gestion des comptes utilisateurs est simplifiée, vous permettant de superviser et de réguler les autorisations avec précision. Vous pouvez gérer les stagiaires et les stages/encadrants, les répertoriant, les recherchant et marquant leurs absences au besoin. De plus, vous avez la capacité d'imprimer des attestations importantes et d'envoyer des emails pour une communication rapide et efficace. Enfin, l'affichage des statistiques vous donne une vue d'ensemble claire pour évaluer et améliorer les processus internes de manière éclairée.</p>
	</div>
<div class="ALL">
