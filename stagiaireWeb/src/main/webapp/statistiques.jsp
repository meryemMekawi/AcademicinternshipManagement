...
<div class="ALL">
    <div class="row justify-content-center">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Nombre actuel des Stagiaires</h5>
                <p class="card-text">Nouveau : ${nombreStagiairesParStatut[0]}</p>
    ...
    <!-- Carte pour le nombre de Stages -->
    <div class="col-md-4 mb-4">
        ...
        <div class="card">
                <div class="card-body">
                <h5 class="card-title">Nombre d’Encadrants</h5>
                <p class="card-text">Affectés : ${nombreEncadrantsParStatut[0]}</p>
                <p class="card-text">Non Affectés : ${nombreEncadrantsParStatut[1]}</p>
  </div></div></div></div></div>
