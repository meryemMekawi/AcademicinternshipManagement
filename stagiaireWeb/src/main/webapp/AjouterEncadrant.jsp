...
<div class="t">
    <form action="ajouterEncadrantServlet" method="GET">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="departement" name="departement" required>
                ...
                <!-- Ajoutez d'autres options selon les départements que vous souhaitez -->
            </select>
        </div>
        ...
        <button type="submit" class="btn btn-primary">Ajouter Encadrant</button>
    </form>
