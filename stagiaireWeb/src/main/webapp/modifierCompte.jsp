...
<nav class="navbar navbar-expand-lg custom-navbar">
   ...
   <div class="titre centered">
    <h2>Modifier le Compte</h2></div>
    <div class="t">
    <h2>Compte ID = ${compte.identifiant}</h2>
    
    <form action="MCompteServlet" method="get">
        <input type="hidden" name="compteId" value="${compte.identifiant}">

        
        <div class="form-group">
            <label for="login">Login:</label>
            <input type="text" class="form-control" id="login" name="login" value="${compte.login}">
        </div>
        
        <div class="form-group">
            <label for="motDePasse">Mot De Passe:</label>
            <input type="text" class="form-control" id="motDePasse" name="motDePasse" value="${compte.motDePasse}">
        </div>
        
        <div class="form-group">
            <label for="typeCompte">Type Du Compte:</label>
            <input type="text" class="form-control" id="typeCompte" name="typeCompte" value="${compte.typeCompte}">
        </div>
