           ...
           <table class="table table-bordered table-striped align-left">
            <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Statut</th>
                        <th>Email</th>
                        <!-- Ajoutez d'autres colonnes en fonction des informations que vous souhaitez afficher -->
                    </tr>
                </thead>
            
                    <tbody>
                <c:forEach var="encadrant" items="${resultats}">
                    <tr>
                        <tr>
                            <td>${encadrant.getIdentifiant()}</td>
                            <td>${encadrant.getCin()}</td>
                            <td>${encadrant.getNom()}</td>
                            <td>${encadrant.getPrenom()}</td>
                            <td>${encadrant.getDepartement()}</td>
                            <td>${encadrant.getStatut()}</td>
                            <td>${encadrant.getEmail()}</td>
