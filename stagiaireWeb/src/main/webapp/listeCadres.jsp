...
<nav class="navbar navbar-expand-lg custom-navbar">
   ...
   <div class="titre centered">
    ...
    <h2>Liste des Cadres Sans Compte</h2></div>
<!-- Lister tous les encadrants -->
    <table class="table table-bordered table-hover">
        <tbody>
            <c:forEach var="cadre" items="${unassignedCadres}">
                <tr>
                    <td>${cadre.nom}</td>
                    <td>${cadre.prenom}</td>
                    <td>
                        <form action="ConfirmerAttributionActionServlet" method="post">
                            <input type="hidden" name="compteId" value="${selectedCompte.identifiant}">
