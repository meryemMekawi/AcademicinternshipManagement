...
<nav class="navbar navbar-expand-lg custom-navbar">
   ...
   <div class="titre centered">
        ...
        <!-- Formulaire pour chercher un stage par ID -->
        <div class="t">
        <form action="ChercherStageServlet" method="get" class="mb-4">
            <h2>Chercher un stage par ID</h2>
            <div class="form-group">
                <label for="idStage">ID du stage :</label>
                <input type="text" class="form-control" id="idStage" name="idStage" required>
            </div>
            <button type="submit" class="btn btn-primary">Rechercher</button>
        </form>

        <!-- Tableau pour afficher la liste des stages -->
